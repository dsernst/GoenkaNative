...
function RecentlyJoinedContact({ displayName, onesignal_id, recentlyJoinedContact, user }: RecentlyJoinedContactProps) {
  ...
  return (
    <View style={{ marginTop: 0 }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        ...
        >
          <Text style={{ color: '#fff6', fontSize: 13, fontWeight: '600' }}>Ignore</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={{ color: '#fff9', fontSize: 13, fontWeight: '600' }}>Send Friend Request</Text>
        </TouchableOpacity>
      </View>
